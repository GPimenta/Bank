...
//				showAllCustomers();
	...
	private static void editSecondaryAccounts() {
		Customer_Old customer = checkNameAndPassword();
		Integer choose;
	...
	private static void addSecondaryAccount(Customer_Old customer) {
	...
	private static boolean checkIfAccountHolderExists(String secondaryAccount) {
		for (Customer_Old costumer : customers) {
			if (costumer == null)
				break;
	...
	private static int checkSecondaryAccounts(Customer_Old customer) {
		Integer index = 4;
	...
	private static void deleteSecondaryAccount(Customer_Old customer) {
	...
	private static boolean checkIfItHasSecondaryAccounts(Customer_Old customer) {
	...
	private static void deleteDebitCard(Customer_Old customer) {
	...
	private static void deleteCreditCard(Customer_Old customer) {
		System.out.println("Do you whish to delete a Debit Card? y/n");
		if (scanner.next().equals("y")) {
	...
	private static void createDebitCard(Customer_Old customer) {
	...
	private static void createCreditCard(Customer_Old customer) {
	...
	private static void createDebitCardDetails(Customer_Old customer) {
	...
	private static void createCreditCardDetails(Customer_Old customer) {
	...
	private static void deleteDebitCardDetails(Customer_Old customer) {
	...
	private static void deleteCreditCardDetails(Customer_Old customer) {
	...
	private static void depositMoneyOnHolderAccount(Customer_Old customer) {
	...
	private static void depositMoneyOnSecundaryAccount(Customer_Old customer) {
		...
		for (Customer_Old getCustomer : customers) {
	...
	private static void withdrawMoneyOnHolderAccount(Customer_Old customer) {
	...
	private static void withdrawMoneyOnSecondaryAccount(Customer_Old customer) {
		String secundaryAccount = checkSecondaryAccount(customer);
		String decision;
	...
	private static String checkSecondaryAccount(Customer_Old customer) {
	...
	private static void transferMoney(Customer_Old customer) {
		...
		for (Customer_Old customerToTransfer : customers) {
	...
	private static void showAccountHistoryMovement(Customer_Old customer) {
	...
	private static void addTAccountHistoryMovement(Customer_Old customer, String amount) {
	...
	private static Customer_Old editCustomerDetails(Customer_Old customer) {
		Integer change;
		do {
	...
	private static Customer_Old populateEmptyDatabase() {
		System.out.println("Creating new client");
		Customer_Old newCustomer = new Customer_Old();
	 ...
	 * @return
	 ******************************************************************************/
	private static Customer_Old checkNameAndPassword() {
